...
`2011`
Ranzato, M., Susskind, J.M., Mnih, V., & Hinton, G.E. (2011). [On Deep Generative Models with Applications to Recognition.](https://ieeexplore.ieee.org/abstract/document/5995710) __Proc. of Computer Vision and Pattern Recognition Conference (CVPR 2011)__, Colarodo Springs, 2011.

`2008`
Nair, V., Susskind, J.M., and Hinton, G.E. (2008). [Analysis-by-synthesis by Learning to Invert Generative Black Boxes.](https://link.springer.com/chapter/10.1007/978-3-540-87536-9_99) __Artificial Neural Networks – ICANN__ 2008.

`2006`
Littlewort, G., Bartlett, M., Fasel, I., Susskind, J.M., and Movellan, J.R. (2006). An automatic system for measuring facial expression in video. __Image and Vision Computing__ 24(6), p. 615-625.

`2004`
Movellan, J.R, Hershey, J., and Susskind, J.M. (2004). Large Scale Convolutional HMMs for Real Time Video Tracking. __Proc. of Computer Vision and Pattern Recognition Conference (CVPR 2004)__. 2004.
